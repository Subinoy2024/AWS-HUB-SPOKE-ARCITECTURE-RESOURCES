...
Root module for deploying spoke workload VPCs. Runs identically across 30 spoke accounts.
...
- To onboard a new spoke (e.g. spoke 31), simply create `spoke-31.tfvars`.
